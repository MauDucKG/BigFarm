...
<header>
    ...
    <body>
        ...
        <div class="introduction">
            <div class="wrapper">
                <img src="assets/images/burgess-milner-OYYE4g-I5ZQ-unsplash.jpg" alt="">
            <section class="our-introduction">
                <div class="container" data-aos="fade-up">
                <div class="row content" >
                <div class="container px-4 px-lg-6">
                <div class="row m-4">
                  <h2 class="text-center mt-3" style="margin-bottom:40px;" ><span class="red">BIG</span><span class="green">FARM</span> - <span class="fw-bold">NÂNG NIU VÓC DÁNG VIỆT</span></h2><br>
              <p class = "text-center">
                <div class="fw-bold special-text" style="margin-bottom:40px;">Fashion for all</div>
              <p class="fst-italic justify-content intro-text">
              ...
              <p class="fst-italic intro-text">Thiết kế kết hợp từ 2 gam màu chủ đạo là vàng và cam: </p>
                <ul class="fst-italic intro-text">
